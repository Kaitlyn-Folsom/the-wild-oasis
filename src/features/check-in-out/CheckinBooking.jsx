...
function CheckinBooking() {
  ...
  const { id: bookingId, guests, total_price, num_guests, has_breakfast, num_night } = booking;

  const optionalBreakfastPrice = settings.breakfast_price * num_night * num_guests;
